...
class AssortmentCache:
    def __init__(self, ms, cache_path: str, article2meta: dict[str, dict], article2price: dict[str, int]):
        self.ms = ms
        self.cache_path = cache_path
        self.article2meta = article2meta
        self.article2price = article2price
    ...
    def get_price(self, article: str) -> int | None:
        return self.article2price.get(article)
